...
class AjaxProxy
{
     ...
     * @var string
     */
    protected $_requestUserAgent  = "Mozilla/5.0 (Windows; U; Windows NT 5.1; rv:1.7.3) Gecko/20041001 Firefox/0.10.1";
    ...
    protected function _loadRoute()
    {
        ...
        $this->_route = substr($_SERVER["QUERY_STRING"], 6);
    }
    ...
    public function saveCache()
    {
        ...
        $dir_path = explode("?", $this->_route);
        $path_parts = pathinfo($dir_path[0]);

        $new_dir = $path . "/../worldbank/json" . $path_parts['dirname'];
